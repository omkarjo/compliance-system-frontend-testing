...
const FormGenerate = ({
  ...
  const genrateField = useCallback((field, formField, index) => {
    switch (formField.type) {
      ...
      case "phone":
        return <PhoneInput {...field} defaultCountry="IN" autoComplete="tel" />;
      case "country_select":
        return (
          <CountryDropdown
            placeholder="Country"
        ...
        {formFields.map((formField, index) => {
          ...
          return (
            <FormField
              ...
              name={formField.name}
              render={({ field }) => (
                <FormItem className={cn(formField?.className)}>
                  {formField?.label && (
                    <FormLabel>
                      <span>
                        {formField.label}
